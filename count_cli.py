...
def main():
    ...
    parser.add_argument("--body-threshold", type=int, default=28)
    parser.add_argument("--merge-strength", type=float, default=0.80)
    parser.add_argument("--split-strength", type=float, default=0.34)
    parser.add_argument("--min-area-ratio", type=float, default=0.00035)
    parser.add_argument("--max-area-ratio", type=float, default=0.090)
